...
/* var galleryThumbs = swiper(".banner-slider", {
  slidesPerView: 1,
  spaceBetween: 10,
  autoplay: {
    delay: 5000,
...
/* var galleryTop = swiper(".gallery-top", {
  spaceBetween: 10,
  autoplay: {
    delay: 3000,
    disableOnInteraction: false
